function loadCircularHeatMap (p_departamento, p_anno,p_campana) {
  ...
  queue()
    .defer(d3.json, "https://raw.githubusercontent.com/63anp3ca/HomeWork2/master/colombia.geo.json")
    .defer(d3.csv, "https://raw.githubusercontent.com/63anp3ca/HomeWork2/master/datafin.csv")
  ...
  if (p_departamento  != "COLOMBIA"){
   ...
   function dblclick() {
        loadCircularHeatRed(p_departamento, p_anno,p_campana);
    }
